    ...
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <td><?= $produto->id ?></td>
                    <td><?= $produto->idsubcategoria0->nome ?></td>
                    <td><?= $produto->idmarca0->nome ?></td>
                    <td><?= $produto->nome ?></td>
                    <td><?= $produto->usado ? 'Sim' : 'Não' ?></td>
                    <td><?= $produto->preco . '€' ?></td>
                    <td><?= $produto->stock ?></td>
                    <td>
                        <a href="/produtos/view?id=<?= $produto->id ?>" title="View" aria-label="View" data-pjax="0">
                        ...
                        <a href="/produtos/update?id=<?= $produto->id ?>" title="Update" aria-label="Update" data-pjax="0">
                        ...
                        <a href="/produtos/delete?id=<?= $produto->id ?>" title="Delete" aria-label="Delete" data-pjax="0" data-confirm="Are you sure you want to delete this item?" data-method="post">
